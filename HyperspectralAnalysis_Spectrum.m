...
%             end;
        ...
        case 2 % Select_spectra: Selects spectrum from ROI
            ...
            [~,~,Spectrum_subAve(:,num_spectrum),Spectrum_subStd(:,num_spectrum),cont]=Select_spectra_ROI; %**Benedetto** (aggiunta di cont)
...
% end
    ...
    function [Spectrum_subAveWL,Spectrum_subStdWL,...
            Spectrum_subAve,Spectrum_subStd,cont]=Select_spectra_ROI % Selects a ROI and calculates the average spectrum of that ROI  %**Benedetto** (aggiunta di cont)
