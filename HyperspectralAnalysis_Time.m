...
linearFit=Dinput('\n    Subtraction from interferogram of: [0: constant line - 1: linear trend]? ',0);
...
if Sp_filt
    ...
    linearFit=Dinput('\n          0 = constant line (faster) - 1 = linear trend (slower) ? ',linearFit);
...
%     end;
    ...
    for y=1:a
        ...
        for x=1:b % it was parfor
            ...
            if linearFit  % Subtracts a line insted of a constant
